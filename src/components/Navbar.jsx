      ...
      <header
        className={
          !navState
            ...
            : "fixed top-0 left-0 right-0 h-[9vh] flex justify-center items-center opacity-100 z-[200] blur-effect-theme"
        }
      >
        <nav className="flex justify-between items-center nike-container">
          ...
          <ul className="flex justify-center item-center gap-2 ">
