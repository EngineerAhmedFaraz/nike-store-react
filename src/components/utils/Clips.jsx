  ...
  return (
    <>
      ...
      >
        ...
        />
        <div className="bg-white blur-effect-theme absolute top-11 left-11 lg-top-8 lg:left-9 sm:top-4 sm:left-5 right-0 w-8 h-8 md:w-5 md:h-5 flex items-center justify-center rounded-full  opacity-100 z-[100]">
