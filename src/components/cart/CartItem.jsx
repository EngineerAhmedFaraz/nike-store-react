      ...
      <div className="flex justify-between items-center w-full px-5">
        <div className="flex items-center gap-5">
          ...
          >
            ...
            />
            <div className="absolute right-1 top-1 blur-theme-effect bg-white/80 text-xs px-1 rounded">
              ${price}
            </div>
          </div>
          <div className="grid items-center gap-4">
            ...
            <div className="flex justify-around items-center w-full">
              ...
              <div className="bg-theme-cart rounded text-white font-medium lg:text-xs w-7 h-6 lg:w-6 lg:h-5 flex justify-center items-center">
                {cartQuantity}
              </div>
              <button
                type="button"
